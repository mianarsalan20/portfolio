  ...
  return (
    ...
    <div className="contact__container container grid">
        ...
        <div className="contact__box">
          <div>
            <img src={Phone} className="contact__icon"/>
        ...
        <div className="contact__box">
          <div>
            <img src={Email} className="contact__icon"/>
        ...
        <div className="contact__box">
          <div>
            <img src={Homee} className="contact__icon"/>
    ...
    <span className="footer">© All Copyright Reserved 2023</span>
</section>
  )
}
